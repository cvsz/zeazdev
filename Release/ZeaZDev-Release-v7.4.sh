...
# 📦 Version: Release — v7.4 (Hotfix 14)
...
# 🔐 License: MIT
# =============================================================================
# HOTFIX v7.4 (Critical Dependency Fix):
# 1. [FIX] (Hardhat) Added 'npm cache clean --force' before NPM install.
# 2. [FIX] (Hardhat) Removed 'Auto-Heal HH801' step, which may have
#    re-introduced Ethers v6 conflicts and caused 'Compile failed' errors.
# 3. [FIX] (Frontend) Downgraded '@worldcoin/idkit' from '1.1.2' to '1.0.0'
#    to fix Parcel build failure ("Cannot load file './hooks/useIDKit'").
# 4. [FIX] (Frontend) Removed explicit '@worldcoin/idkit-core' install.
# 5. [FIX] Includes all fixes from v6.5-v7.3 (apt-get, .env, 502, Ethers v5).
# =============================================================================
...
/* 🌐 ZeaZDev v7.4 (ZEA Token) 👨‍💻 PHIPHAT PHOEMSUK */
...
/* 🌐 ZeaZDev v7.4 (Airdrop) 👨‍💻 PHIPHAT PHOEMSUK */
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
/* 🌐 ZeaZDev v7.4 (Reward Contract) 👨‍💻 PHIPHAT PHOEMSUK */
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
...
/* 🌐 ZeaZDev v7.4 (Deploy Script - Ethers v5 Syntax) 👨‍💻 PHIPHAT PHOEMSUK */
...
/* 🌐 ZeaZDev v7.4 (Hardhat Config) 👨‍💻 PHIPHAT PHOEMSUK */
...
/* 🌐 ZeaZDev v7.4 (Dashboard Server) 👨‍💻 PHIPHAT PHOEMSUK */
...
</head><body><header><strong>ZeaZDev Dashboard (v7.4)</strong> — Deploy & Logs (Live)</header>
...
npm pkg set type="module" >/dev/null 2>&1 || true
# --- [FIX v7.4] ---
info "Installing frontend dependencies (pinning @worldcoin/idkit@1.0.0)..."
...
/* 🌐 ZeaZDev v7.4 (Frontend) 👨‍💻 PHIPHAT PHOEMSUK */
